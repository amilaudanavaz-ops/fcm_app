...
class _AnalyticsViewState extends State<AnalyticsView> {
  ...
  Future<void> _fetchData() async {
    ...
    try {
      ...
      // PERFORMANCE & SECURITY FIX: Concurrent fetching, strict user_id filtering
      ...
      final rate = income > 0 ? (surplus / income) * 100 : 0.0;
                    ...
                    children: [
                      const Expanded(
                        child: Text(
                          ...
                          maxLines: 1,
                          overflow: TextOverflow.ellipsis, // Prevents text overflow on small screens
                        ),
                      ),
                      const SizedBox(width: 8),
                      // iOS Style Sliding Segmented Control Equivalent
                      Container(
                        ...
                        child: Row(
                          mainAxisSize: MainAxisSize.min, // Hugs content to prevent overflow
                          children: [
                            GestureDetector(
                              onTap: () {
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  boxShadow: _selectedBreakdownIndex == 0 ? [BoxShadow(color: Colors.black.withValues(alpha: 0.1), blurRadius: 4, offset: const Offset(0, 2))] : [],
                                ),
                            ...
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  borderRadius: BorderRadius.circular(16),
                                  boxShadow: _selectedBreakdownIndex == 1 ? [BoxShadow(color: Colors.black.withValues(alpha: 0.1), blurRadius: 4, offset: const Offset(0, 2))] : [],
                                ),
